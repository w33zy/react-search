	...
	_createClass(SearchForm, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement('input', { className: 'search-input react', type: 'text', onKeyUp: this.getResults }),
...
var SearchResults = function SearchResults(props) {
	...
	if (props.loading) {
		...
		var _results = props.results.map(function (result) {
